...
class SinglPlayFragment : Fragment() {
    ...
    // استخدم navArgs للوصول إلى المعطيات الممررة
//    val args: SinglPlayFragmentArgs by navArgs()
//    val player1Name = args.player1Name // تأكد من أن اسم اللاعب يتم استلامه بشكل صحيح
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // إذا كانت المعطيات null تأكد من إعطاء قيمة افتراضية
//        val player1Name = args.player1Name ?: "Player 1"  // استخدم القيمة الافتراضية إذا كانت فارغة
